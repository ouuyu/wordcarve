  ...
  <div class="max-w-2xl">
    <div class="flex flex-col items-start">
      ...
      <div class="relative mt-4 min-h-[200px] w-full py-4">
        <div v-if="searchResult" class="max-w-3xl w-full perspective-1000">
          <WordDisplay
            :word="searchResult"
            mode="normal"
        ...
        <div v-if="previousResult && currentCardState" class="absolute left-0 top-0 max-w-3xl w-full perspective-1000">
          <WordDisplay
            :word="previousResult"
            mode="normal"
